...
community-2 = { -brand-short-name } is designed by <label data-l10n-name="community-mozillaLink">raytek.cafe</label>, a group of friends working together to make tech friendly and accessible like it used to be.
